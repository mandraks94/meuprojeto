...
Sub Analisar()
    ...
    Dim atm As String, dataPeriodo As String
    Dim tableRows As WebElements, tableRow As WebElement
    Dim linhaEncontrada As Boolean, temDadosNaAba As Boolean
    ...
    For i = 8 To ultimaLinha
        ...
        With cd
            ...
            If i = 8 Then
                timeout = 120 ' Timeout de 120s (2 min) para a primeira execução
            Else
