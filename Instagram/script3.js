    ...
    function initScript() {
        if (window.location.href.includes("instagram.com")) {
            ...
            function getRolloutHash() {
                ...
                try {
                    if (win.__p && win.__p.rollout_hash) {
                        cachedRolloutHash = win.__p.rollout_hash;
            ...
            function getWWWClaim() {
                ...
                try {
                    ...
                    const claim = win.__p?.www_claim ||
                                  win._sharedData?.config?.viewer?.www_claim ||
                                  win.__cu?.www_claim ||
                                  win.__v?.www_claim ||
                                  win.__DTS?.www_claim ||
                                  win._sharedData?.config?.viewer?.www_claim;
